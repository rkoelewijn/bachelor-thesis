...
For our tests, we will be using \textcolor{red}{30} different output examples, collected from \textcolor{red}{DATE} untill \textcolor{red}{DATE}. \todo{Add no of experiments and dates. }
...
This is then stored in a different JSON object (Listing \ref{lst:text_json}). \todo[color=blue]{add how i do the text extraction when finished.}
