...
\subsection{Loading Text} \todo[color=blue]{change title  + add when implemented}
...
\subsection{Classification} \todo[color=gray]{Add when decided on whether to implement}