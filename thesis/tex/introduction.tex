...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[\textbf{RQ 1.1}] How accurately can a cross-lingual NLI baseline detect and classify intrinsic hallucinations by evaluating semantic entailment between English atomic claims and their Dutch source texts, and to what extent does it label extrinsic hallucinations with a neutral or supported verdict?
        ...
        \item[\textbf{RQ 1.3}] How effectively can the integration of the MusicBrainz external knowledge graph increase the accuracy of atomic and sentence level labels of the baseline by validating extrinsic hallucinations?
